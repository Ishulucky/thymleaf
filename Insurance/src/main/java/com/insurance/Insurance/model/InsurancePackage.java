...
@Entity
@Table(name = "ish_InsurancePackages")
public class InsurancePackage {
	...
	public InsurancePackage(Long id, String title, String description, String status, Double rangeStart,
	...
	public String toString() {
		return "InsurancePackage [id=" + id + ", title=" + title + ", description=" + description + ", status=" + status
